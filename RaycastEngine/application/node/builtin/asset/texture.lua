...
local NodeDef =
{
    ...
    order = 5,
    menu_visible = true,
    asset_payload = "texture",
    }
}

return Common.make_definition(NodeDef.texture, function(ctx)
    ...
    builder:add_output({key = "texture", type_id = "texture", options = {width_input = 100, dynamic_width_input = true}})
    return node
end)
