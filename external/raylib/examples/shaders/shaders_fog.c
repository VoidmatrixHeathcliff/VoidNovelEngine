...
int main(void)
{
    ...
    while (!WindowShouldClose())        // Detect window close button or ESC key
    {
        ...
        // Rotate the torus
        modelA.transform = RMATH_MatrixMultiply(modelA.transform, MatrixRotateX(-0.025f));
        modelA.transform = RMATH_MatrixMultiply(modelA.transform, MatrixRotateZ(0.012f));
