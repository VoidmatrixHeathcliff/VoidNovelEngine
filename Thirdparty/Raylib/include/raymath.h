...
// Get identity matrix
RMAPI Matrix RMATH_MatrixIdentity(void)
{
...
RMAPI Matrix RMATH_MatrixMultiply(Matrix left, Matrix right)
{
    Matrix result = { 0 };
...
inline Matrix operator * (const Matrix& lhs, const Matrix& rhs)
{
    return RMATH_MatrixMultiply(lhs, rhs);
}

inline const Matrix& operator *= (Matrix& lhs, const Matrix& rhs)
{
    lhs = RMATH_MatrixMultiply(lhs, rhs);
    return lhs;
}
//-------------------------------------------------------------------------------
#endif  // C++ operators
